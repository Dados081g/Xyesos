...
MAIN_KB = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="Категория", icon_custom_emoji_id=EMOJI_CATEGORY, style="danger")],
        [
            KeyboardButton(text="👤 Профиль", icon_custom_emoji_id="5258508428212445001"),
            KeyboardButton(text="📢 Наш канал", icon_custom_emoji_id="5258513401784573443"),
        ],
        [
            KeyboardButton(text="📋 Соглашение", icon_custom_emoji_id="5890883384057533697"),
            KeyboardButton(text="❓ Помощь", icon_custom_emoji_id="5454386656628991407"),
        ],
    ],
